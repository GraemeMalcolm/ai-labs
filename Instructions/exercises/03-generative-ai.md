...
1. In the **Start building** menu, select **Browse models** to view the Microsoft Foundry model catalog.
    ...
    ![Screenshot of the AI Foundry model catalog.](./media/foundry-models.png)
...
1. Search for and select the `gpt-4.1-mini` model, and view the page for this model, which describes its features and capabilities.
    ...
    ![Screenshot of the gpt-4.1-mini model page.](./media/gpt-4.1-mini.png)
...
1. Switch back to the **Chat** tab, and enter the prompt `What can you do?`
    ...
    ![Screenshot of the agent's response describing its capabilities.](./media/agent-capabilities.png)
...
1. Open a new browser tab, and view the **[expenses_policy.docx](https://raw.githubusercontent.com/GraemeMalcolm/ai-labs/refs/heads/main/data/expenses_policy.docx){:target="_blank"}** at `https://raw.githubusercontent.com/GraemeMalcolm/ai-labs/refs/heads/main/data/expenses_policy.docx`. We'll use this to provide a knowledge source that the agent can use to answer questions about expense claims.
...
1. Upload the **expenses.docx** file, creating a new index with the default index name. When the index has been created, attach it to the agent.
...
1. In the preview web page that opens in a new tab, enter a prompt such as `How do I submit an expense claim?` and review the response.
    ...
    ![Screenshot of the agent preview page.](./media/agent-preview.png)
